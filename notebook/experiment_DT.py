...
try:
    config = toml.load("./config/experiment/ccRCC_imm_DT.toml")
...
param_grid = {
    ...
    'max_features': config['decision_tree']['max_features']
}
...
# 保存nadata对象到配置的输出目录
output_file = os.path.join(output_dir, "ccRCC_imm_DT.pkl")
...
with open(summary_file, 'w', encoding='utf-8') as f:
    f.write("DecisionTreeClassifier 训练结果摘要\n")
    f.write("=" * 50 + "\n")
