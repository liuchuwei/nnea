...
try:
    config = toml.load("./config/LR_config.toml")
...
# 设置日志输出到输出目录
log_file = os.path.join(output_dir, "logistricRegress_experiment.log")
...
# 保存nadata对象到配置的输出目录
output_file = os.path.join(output_dir, "ccRCC_imm_LR.pkl")
