...
# Read LogisticRegression configuration file
try:
...
logger.info("⚙️ Reading LogisticRegression configuration file...")
...
if config['logistic_regression']['feature_selection']:
    ...
    logger.info(f"✅ Feature selection completed, selected features: {config['logistic_regression']['n_features']}")
...
# Build LogisticRegression result dictionary
logreg_result = {
...
logger.info(f"✅ Logistic regression model training completed and saved to: {output_file}")
...
with open(summary_file, 'w', encoding='utf-8') as f:
    f.write("LogisticRegression Training Results Summary\n")
    f.write("=" * 50 + "\n")
