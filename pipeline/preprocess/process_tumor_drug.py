...
class TumorDrugProcessor:
    ...
    def process_single_drug(self, drug_name):
        ...
        try:
            ...
            sources = drug_phe['source'].value_counts().head(4).index.tolist()
            ...
            common_samples = sorted(set(merged_exp.columns) & set(Meta['id']))
            ...
            # 按照common_samples的顺序重新排列Meta
            Meta = Meta.set_index('id').reindex(common_samples).reset_index()
